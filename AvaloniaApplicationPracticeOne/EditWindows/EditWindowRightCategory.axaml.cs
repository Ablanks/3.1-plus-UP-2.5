...
public partial class EditWindowRightCategory : Window
{

    private TextBox nameTBox;
    private RightCategory editUser;
    
    public EditWindowRightCategory()
    {
        InitializeComponent();
    ...
    public EditWindowRightCategory(RightCategory editUser)
    {
        InitializeComponent();
    ...
    private void EditBtn_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        else
        {
            var messageBoxStandardWindow = MessageBox.Avalonia.MessageBoxManager
                .GetMessageBoxStandardWindow("Ошибка", "Поле с типом категории пустое");
