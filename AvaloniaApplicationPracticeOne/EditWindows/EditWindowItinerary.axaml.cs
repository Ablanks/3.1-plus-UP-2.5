...
public partial class EditWindowItinerary : Window
{

    private TextBox nameTBox;
    private Itinerary editUser;
    
    public EditWindowItinerary()
    {
        InitializeComponent();
    ...
    public EditWindowItinerary(Itinerary editUser)
    {
        InitializeComponent();
    ...
    private void EditBtn_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        else
        {
            var messageBoxStandardWindow = MessageBox.Avalonia.MessageBoxManager
                .GetMessageBoxStandardWindow("Ошибка", "Поле с названием маршрута пустое");
